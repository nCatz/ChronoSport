...
public class DatabaseContract {
    ...
    public static class ChronoRepetitionElementEntry implements BaseColumns{
        ...
        public static final String REFERENCE_CHRONO_TABLE_FK = String.format("REFERENCES %s (%s) ON DELETE RESTIRCT ON" +
                "UPDATE CASCADE", ChronoEntry.TABLE_NAME, ChronoEntry._ID);
        public static final String SQL_CREATE_ENTRIES = String.format("CREATE_TABLE %s (" +
